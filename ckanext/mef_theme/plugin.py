...
class MEFThemeCustomizations(plugins.SingletonPlugin):
    ...
    def update_config(self, config):
        ...
        our_public_dir = os.path.join(rootdir, 'ckanext', 'mef_theme', 'theme',
                'public')
        template_dir = os.path.join(rootdir, 'ckanext', 'mef_theme', 'theme',
                'templates')
        ...
        toolkit.add_resource('theme/resources', 'ckanext-mef_theme')
